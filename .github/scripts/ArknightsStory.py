...
# git clone -b github-action https://github.com/GDFSCJY/test-auto-update-anime-game-multilingual-data.git
...
# git submodule update GAMEDATA/ArknightsData
callsh('git submodule update GAMEDATA/ArknightsData')
